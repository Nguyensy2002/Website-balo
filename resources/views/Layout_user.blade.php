                    ...
                    <div class="col-lg-7 col-md-6 col-sm-6 col-xs-3 hidden-xs category-search-form">
                        <div class="search-box">
                            <form id="search_mini_form" action="{{ route('home.create') }}" method="get">
                                ...
                                <input id="search" type="text" name="search" placeholder="Tìm kiếm sản phẩm"
                        ...
                        <div class="top-cart-contain" id="top-cart-contain">
                            ...
                            <div class="mini-cart">
                                <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle">
                                    <a href="{{ route('cart.index') }}"><span class="price hidden-xs">GIỎ HÀNG</span>
                                    ...
                                    <div class="top-cart-content" id="top-cart-content">
                                        ...
                                        <div class="actions">
                                            <button class="btn-checkout" title="Checkout" type="button">
                                                @if (Auth::user())
                                                    <a style="color: #fff;"
                                                        href="{{ route('cart-address.index') }}"><span>THANH TOÁN</span></a>
                                                @else
                                                    <a style="color: #fff;"
                                                        href="{{ route('login.index') }}"><span>THANH TOÁN</span></a>
                                                @endif
                                            </button>
                                            <a href="{{ route('cart.index') }}" class="view-cart"><span>CHI TIẾT</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
