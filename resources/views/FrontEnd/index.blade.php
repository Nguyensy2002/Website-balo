                        ...
                        <div class="navbar nav-menu">
                            <div class="navbar-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="active"><a data-toggle="tab" href="#tab-0">Tất cả</a></li>
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="action">
                                                                <button class="button btn-cart add_cart" type="button"
                                                                    ...
                                                                    data-original-title="Add to Cart"><span>THÊM GIỎ HÀNG</span> </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="item-content">
                                            ...
                                            <div class="action">
                                                <button data-original-title="Add to Cart" title="" type="button" data-id_pro="{{ $item->product_id }}"
                                                    class="button btn-cart add_cart"><span>Thêm giỏ hàng</span> </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
